...
export const NewsCard = ({ title, summary, image }) => {
  return (
    <div className='my-3 py-2 md:py-3 px-0 md:px-4 shadow-md rounded flex flex-col md:flex-row justify-center md:justify-start md:items-center  w-full md:w-1/2 '>
